...
if ( ! class_exists( 'YITH_WCACT_Vendor_Email_Not_Reached_Reserve_Price' ) ) {
    ...
    class YITH_WCACT_Vendor_Email_Not_Reached_Reserve_Price extends WC_Email {
        ...
        public function __construct() {
            ...
            $this->title = __('​Auctions - reserve price not exceeded (to vendor)', 'yith-auctions-for-woocommerce');


            // this is the description in WooCommerce email settings
            $this->description = __('​Can be emailed when the auction has finished, and the highest bid doesn\'t exceed the minimum reserve price  ', 'yith-auctions-for-woocommerce');

            // these are the default heading and subject lines that can be overridden using the settings
            $this->heading = __('Max bid doesn\'t exceed minimum reserve price', 'yith-auctions-for-woocommerce');

            $this->subject = __('Max bid doesn\'t exceed minimum reserve price', 'yith-auctions-for-woocommerce');
