...
if ( ! class_exists( 'YITH_WCACT_Email_Not_Reached_Reserve_Price' ) ) {
    ...
    class YITH_WCACT_Email_Not_Reached_Reserve_Price extends WC_Email {
        ...
        public function __construct() {
            ...
            $this->title = __('​Auctions - reserve price not exceeded', 'yith-auctions-for-woocommerce');
            ...
            $this->heading = __('Max bid doesn\'t exceed the minimum reserve price', 'yith-auctions-for-woocommerce');
