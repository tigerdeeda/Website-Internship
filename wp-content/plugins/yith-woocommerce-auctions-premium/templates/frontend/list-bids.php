...
if (count($auction_list) == 0){
  ...
  <p id="single-product-no-bid"><?php _e('ยังไม่มีผู้ประมูลสำหรับสินค้านี้','yith-auctions-for-woocommerce');?></p>
  ...
  <table id="datatable">
    <tr>
      ...
      <td class="toptable"><?php echo __('จำนวนราคาปรมูล','yith-auctions-for-woocommerce'); ?></td>
