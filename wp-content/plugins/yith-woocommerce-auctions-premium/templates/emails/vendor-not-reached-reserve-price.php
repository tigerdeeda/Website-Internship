...
<?php do_action( 'woocommerce_email_header', $email_heading, $email ); ?>
    ...
    <p><?php printf( __( "Hi!, we would like to inform you that the highest bid for the product:", 'yith-auctions-for-woocommerce' ));?></p>
...
?>
    <p><?php printf( __( "Doesn't exceed the minimum reserve price.", 'yith-auctions-for-woocommerce' )); ?></p>
    <div>
