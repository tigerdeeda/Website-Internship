    ...
    public static function get($identifier)
    {
        switch($identifier)
        {
            ...
            case 'CRON_DISABLED_WARNING':
                return __('Wordpress cron is disabled. Automatic task execution will not work. <a target="__blank" href="https://codex.wordpress.org/Editing_wp-config.php#Disable_Cron_and_Cron_Timeout">More info.</a>','custom-registration-form-builder-with-submission-manager');
