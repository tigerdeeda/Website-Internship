...
<div class="filter-row"><a href="?page=rm_user_manage"><input type="button" name="Reset" value="Reset"></a><input type="submit" name="Search" value="Search"></div>
    ...
    <table>
        ...
        <tr>
            <td><input class="rm_checkbox_group" type="checkbox" onclick="rm_on_users_selection()" <?php echo get_current_user_id()==$user->ID?'disabled':''; ?> value="<?php echo $user->ID; ?>" name="rm_users[]"></td>
