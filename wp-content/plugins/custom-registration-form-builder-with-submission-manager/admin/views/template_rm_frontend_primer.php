...
<div class="rm-features-list">
    ...
    <div class="rm-features-table">
        <div class="rm-features-row">
            ...
            <div class="rm-feature-cell">Four simple ways to register users on your site.</div>
            <div class="rm-feature-cell">
        ...
        <div class="rm-feature-content">
            ...
            <ol>
                ...
                <p>This method to display registration forms on WordPress site is for advanced users and therefore only available in Premium Bundle of RegistrationMagic. It works best when we want to show a RegistrationMagic form where there’s no option to paste the shortcode. For example – a site outside our WordPress site.</p>
        ...
        <div class="rm-feature-content">
            <img src="<?php echo RM_IMG_URL; ?>content-arrow.png" class="content-arrow">
            Login system is built into RegistrationMagic. To display a login box on any page, post or widget use this code <span class="rm-code">[RM_Login]</span>.
        ...
        <div class="rm-feature-content">Front-end submission area also contains tab for transaction details. If you have set up paid registration forms, then this area will display to users with their transaction details including payments status as complete or refunded.
        </div>
        ...
        <div class="rm-features-row">
            ...
            <div class="rm-feature-cell">Easily display list of registered users (Premium)</div>
            <div class="rm-feature-cell">
                <img src="<?php echo RM_IMG_URL; ?>next.png">
            </div>
        ...
        <div class="rm-feature-content">
            <img src="<?php echo RM_IMG_URL; ?>content-arrow.png" class="content-arrow">
            Now you can display registered users' list on front end of your website! The shortcode format is <span class="rm-code">[RM_Users]</span>. This will display all the users (registered through RegistrationMagic) on a page or post where you paste the shortcode. If you want to display only specific users, you can pass two more parameters to the shortcode - filter the list by registration form and time of registration. The longer format is <span class="rm-code">[[RM_Users form_id="id" timerange="year"]</span>. Where id should be replaced by ID for the RegistrationMagic form and timerange can be year, month, week or today. Of course, you can use any of the two depending on your needs. IDs of the form can be found in their respective form shortcodes.
            <img src="<?php echo RM_IMG_URL; ?>user-profiles.jpg" class="content-asset">
            <P>Please note, this feature is exclusive to RegistrationMagic Premium.</P>
        </div>
