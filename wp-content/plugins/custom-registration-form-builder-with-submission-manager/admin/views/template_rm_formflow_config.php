    ...
    <div class="operationsbar">
        ...
        <div class="nav">
            <ul>  
                ...
                <li><a class="thickbox rm_form_preview_btn" id="rm_form_preview_action_2" href="<?php echo add_query_arg(array('form_prev' => '1','form_id' => $data->form_id),  get_permalink($data->prev_page)); ?>&TB_iframe=true&width=900&height=600">Preview</a></li>                
    ...
    <div class="rm-grid difl"> 
        ...
        <div class="rm-grid-section dbfl" id="rm-section-icons">           
           ...
           <div class="rm-field-next-step rm_formflow_page_next_btn" data-next_page="#rm_formflow_publish">
               <a href="javascript:void(0)" class="rm-form-setting-btn">Next &nbsp;&nbsp;></a>
           </div>
        </div>
        <!-- End Next step -->
