...
?>
    ...
    <div id="rm-form-publish-info">
        ...
        <div id="rm-form-publish-shortcode-info">
            Paste following shortcode in a post or page to publish this form.
            <div id="rm-form-publish-shortcode" class="rmcode">
                <span id="rmformshortcode"><?php echo "[RM_Form id='{$data->form_id}']"; ?></span>
                <button onclick="rm_copy_content(document.getElementById('rmformshortcode'))">Copy</button>
            </div>
        </div>
...
<!--        <div class="rmrow">
        ...
        <div style="display:none" id="rm_msg_copied_to_clipboard">Copied to clipboard</div>
        <div style="display:none" id="rm_msg_not_copied_to_clipboard">Could not be copied. Please try manually.</div>
    </div>
