                   ...
                   if(response==0)
                    {
                       jQuery( "#rm_import_progress" ).append("(Imported)<br><br>All forms successfully Imported.");
                        ...
                        jQuery( "#rm_import_progress" ).append("<br/><br/>Error: Invalid file format.");
                    }
                    else{
...
$form->addElement(new Element_HTML("<div id='upload'>"));
        ...
        $form->addElement(new Element_Button(RM_UI_Strings::get('LABEL_IMPORT'), "submit", array("id" => "rm_submit_btn", "class" => "rm_btn", "name" => "submit", "onClick" => "jQuery.prevent_field_add(event,'This is a required field.')")));
