...
<!--                                    <td>
    ...
    ?>
            ...
            <div class="rm-sent-emails-notice">
                Sent Emails catalogues all emails generated by RegistrationMagic for the users. It does not reflect if your mail server was able to send the mail. To make sure of that, please see if your <a href="admin.php?page=rm_options_autoresponder">email settings</a> are properly configured. To check mails sent to a single user, go to User Manager, open user's account page and click on the Mails tab. If you have set up front end user account area, you can also ask your users to check their mails by logging in.
           </div>
        </div>
        <?php
