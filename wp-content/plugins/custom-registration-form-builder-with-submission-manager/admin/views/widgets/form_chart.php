...
<div class="rmagic">
    ...
    <div class="rmcontent">
        ...
        $form->addElement(new Element_Select("<b>" . RM_UI_Strings::get('LABEL_CHART_TYPE') . ":</b>", "field_value",array("sot"=>"Submissions over time","conversion_chart"=>"Conversion%","browser_usage_chart"=>"Browser used","browser_conversion"=>"Browser wise conversion") ,array("id"=>"chart_type","class" => "rm_static_field rm_required", "value" => $data->model->get_field_value(), "longDesc"=>RM_UI_Strings::get('HELP_F_CHART_TYPE'))));
        
        $form->addElement(new Element_HTML('<div class="childfieldsrow" id="chart_time_range">'));
            $form->addElement(new Element_Select("<b>" . RM_UI_Strings::get('LABEL_SELECT_TIMERANGE') . ":</b>", "time_range",array("7"=>sprintf("Last %d days",7),"30"=>sprintf("Last %d days",30),"60"=>sprintf("Last %d days",60),"90"=>sprintf("Last %d days",90)) ,array("class" => "rm_static_field", "value" =>$data->model->field_options->time_range , "longDesc"=>'')));
        $form->addElement(new Element_HTML('</div>'));
