<ul class="rm-widget-selector-view">
    ...
    <li class="rm_button_like_links" onclick="add_new_widget_to_page('MapV')" title="Display a location with marker using GoogleMaps">
    ...
    <li class="rm_button_like_links" onclick="add_new_widget_to_page('Form_Chart')" title="Display stats about the form using graphs and charts">
     ...
     <li class="rm_button_like_links" onclick="add_new_widget_to_page('FormData')" title="Display various properties of the form">
     ...
     <li class="rm_button_like_links" onclick="add_new_widget_to_page('Feed')" title="Display latest registrations/ submissions data in your form">
