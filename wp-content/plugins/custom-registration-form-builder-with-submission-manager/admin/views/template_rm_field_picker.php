        ...
        <div class="rm-field-tabs-row rm-dbfl">
            ...
            <div id="rm_common_fields_tab">
                <?php if(!in_array('Username', $primary_fields)) : ?>
                    <div title="Username" class="rm_button_like_links" onclick="add_user_field_to_page('Username')"><a href="javascript:void(0)">Accounts Username</a></div> 
                <?php endif; ?>    
                <?php if(!in_array('UserPassword', $primary_fields)) : ?>
                    <div title="User Password" class="rm_button_like_links" onclick="add_user_field_to_page('UserPassword')"><a href="javascript:void(0)">Accounts Password</a></div> 
                <?php endif; ?>
            </div>
        </div> 
    <?php endif; ?>
<div class="field-selector-pills">
    ...
    <div title="<?php echo RM_UI_Strings::get("FIELD_HELP_TEXT_PRICEV"); ?>" class="rm_button_like_links" onclick="add_new_widget_to_page('PriceV')"><a href="javascript:void(0)"> Total Price</a></div>
