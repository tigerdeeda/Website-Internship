...
<!--- Username delete PopUp -->
        <div id="rm-username-delete" class="rm-modal-view" style="display:none">
            ...
            <div class="rm-modal-wrap">
                <div class="rm-modal-titlebar">
                    <div class="rm-modal-title">Remove Username Field?</div>
                    <span  class="rm-modal-close">&times;</span>
                </div>
                <div class="rm-modal-container">
                    You are about to remove Username field from this form. Consequently, Email field wil be used as 
                    Username field. Registering users can later login using their Email and Password. Do you wish to proceed? 
                  
                </div>
                
                <div class="rm-username-delete-actions">
                        <input type="button" onclick="username_delete(true,'#rm-username-delete')" value="Yes, Remove Username" />
                        <input type="button" onclick="jQuery('#rm-username-delete').toggle()" value="No, Keep Username" />
                    </div>
    ...
    <!--- Password delete PopUp -->
        <div id="rm-userpassword-delete" class="rm-modal-view" style="display:none">
            ...
            <div class="rm-modal-wrap">
                <div class="rm-modal-titlebar">
                    <div class="rm-modal-title">Remove Password Field?</div>
                    <span  class="rm-modal-close">&times;</span>
                </div>
                <div class="rm-modal-container">
                    You are about to remove Password field from this form. Password field will be autogenerated and emailed
                    to the user on successful registration. Do you wish to proceed?
                 
                </div>
                <div class="rm-password-delete-actions">
                        <input type="button" onclick="userpassword_delete(true,'#rm-userpassword-delete')" value="Yes, Remove Password" />
                        <input type="button" onclick="jQuery('#rm-userpassword-delete').toggle()" value="No, Keep Password" />
                    </div>
