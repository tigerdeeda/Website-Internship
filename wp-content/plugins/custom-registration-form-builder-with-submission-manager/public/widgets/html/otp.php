        ...
        <div id="rm_otp_login">
            ...
            <div id="rm_otp_enter_email">
                <div class="dbfl rm_otpw_email rm_otpw_field_container">
                    <input type="text" placeholder="<?php _e('Email or User Name', 'registrationmagic-gold'); ?>" value="" id="rm_otp_econtact" name="<?php echo wp_generate_password(5, false, false); ?>"
                    ...
                    <button class="rm_otpw_next_btn rm_loader rm_otpw_rotate" style="display:none">&#8635;</button>
                      ...
                      <div id="rm_otpw_rememberme_container" class="dbfl">
                        ...
                        <div class="dbfl rm_link">
                            <a href="<?php echo wp_lostpassword_url(); ?>" target="blank"><?php echo RM_UI_Strings::get('MSG_LOST_PASS'); ?></a>
                        </div>
                    </div> 
            </div>
