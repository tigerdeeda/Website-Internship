...
class RM_OTP_Widget extends WP_Widget
{
    ...
    function __construct()
    {
        parent::__construct(
            ...
            __('RegistrationMagic Login', ''), // Name
            array('description' => __('Login system for RegistrationMagic form submissions with OTP login for non-WP users.', ''),) // Args
        );
    }
    /**
    ...
    {
        $title = !empty($instance['title']) ? $instance['title'] : __('RegistrationMagic Login', '');
        ?>
        <p>
