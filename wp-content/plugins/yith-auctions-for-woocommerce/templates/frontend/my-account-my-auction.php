...
<table class="shop_table shop_table_responsive yith_wcact_my_auctions_table">
    <tr>
        <td class="toptable"><?php echo __( 'รูปภาพ', 'yith-auctions-for-woocommerce' ); ?></td>
        <td class="toptable"><?php echo __( 'สินค้า', 'yith-auctions-for-woocommerce' ); ?></td>
        <td class="toptable"><?php echo __( 'ราคาประมูลของคุณ', 'yith-auctions-for-woocommerce' ); ?></td>
        <td class="toptable"><?php echo __( 'ราคาประมูลปัจจุบัน', 'yith-auctions-for-woocommerce' ); ?></td>
        <td class="toptable"><?php echo __( 'สถานะ', 'yith-auctions-for-woocommerce' ); ?></td>
