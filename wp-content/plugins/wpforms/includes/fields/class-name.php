		...
		$fld = $this->field_element(
			...
			array(
				...
				'options' => array(
					...
					'first-last'        => __( 'ชื่อจริง นามสกุล', 'wpforms' ),
