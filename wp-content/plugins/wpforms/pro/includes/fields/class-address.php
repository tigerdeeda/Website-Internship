	...
	public function init() {
		...
		$this->schemes = apply_filters( 'wpforms_address_schemes', array(
			...
			'international' => array(
				...
				'address1_label' => __( 'ที่อยู่บรรทัดที่ 1', 'wpforms' ),
				'address2_label' => __( 'ที่อยู่บรรทัดที่ 2', 'wpforms' ),
				'city_label'     => __( 'อำเภอ', 'wpforms' ),
				'postal_label'   => __( 'รหัสไปรษณีย์', 'wpforms' ),
				'state_label'    => __( 'จังหวัด', 'wpforms' ),
				'states'         => '',
				'country_label'  => __( 'ประเทศ', 'wpforms' ),
