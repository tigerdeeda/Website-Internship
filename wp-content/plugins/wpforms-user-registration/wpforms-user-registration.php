 ...
 * Version:     1.0.9
 * Text Domain: wpforms_user_registration
...
// Plugin version
define( 'WPFORMS_USER_REGISTRATION_VERSION', '1.0.9' );
...
function wpforms_user_registration_textdomain() {
	...
	load_plugin_textdomain( 'wpforms_user_registration', false, dirname( plugin_basename( __FILE__ ) ) . '/languages/' );
}
